...
\end{itemize}
\bigskip
\input{identified_characteristics}
...
\input{programming_support}
\input{virtual_machine}
\input{sensor_virtualization}
\input{cloud}

\input{data_virtualization}
%\input{middleware}

\input{mobile_code}
\input{database_virtualization}
\input{network_virtualization}
\input{conclusion}
\pagebreak
